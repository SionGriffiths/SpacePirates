...
function SolarSystem() {
	...
	this.draw = function() {
		...
		grd.addColorStop( 0.1, "rgba(247, 209, 84, 1)");
		grd.addColorStop( 0.2, "rgba(240, 193, 38, 0.4)");
		grd.addColorStop( 0.3, "rgba(240, 193, 38, 0.1)");
		grd.addColorStop( 0.9, "rgba(240, 193, 38, 0.05)");
